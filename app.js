// app.js v274 - LED rechts + telling 10/10 + SYNC RACE FIX + LION BADGE - terug naar vanavond werkend
// app.js v274 - SYNC RACE FIX + LION BADGE alle bronnen + focus alleen artikel omlijnd
...
function renderArticles(){
  ...
  // v274 fix 0/0 - update filter counts after articles filtered
...
async function refreshNews(){
  ...
  updateHeaderCount(); renderArticles(); renderFilters(); updateSourceLeds();
  console.log('refreshNews klaar v274 FIX 0/0', allArticles.length, 'artikelen');
}
